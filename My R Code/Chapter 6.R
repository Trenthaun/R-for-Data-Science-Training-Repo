...
d <- read.table('~/Documents/GitHub/R-for-Data-Science-Training-Repo/KDD2009/orange_small_train.data.gz',    # Note: 1 
                header=T,
                sep='\t',
                na.strings=c('NA','')) 	# Note: 2 
churn <- read.table('~/Documents/GitHub/R-for-Data-Science-Training-Repo/KDD2009/orange_small_train_churn.labels.txt',
                    header=F,sep='\t') 	# Note: 3 
d$churn <- churn$V1 	# Note: 4 
appetency <- read.table('~/Documents/GitHub/R-for-Data-Science-Training-Repo/KDD2009/orange_small_train_appetency.labels.txt',
                        header=F,sep='\t')
d$appetency <- appetency$V1 	# Note: 5 
upselling <- read.table('~/Documents/GitHub/R-for-Data-Science-Training-Repo/KDD2009/orange_small_train_upselling.labels.txt',
                        header=F,sep='\t')
